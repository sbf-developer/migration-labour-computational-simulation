...
Table~\ref{tab:calibration_fit} compares targets to simulated pre-shock moments under \emph{M6}: several moments---notably native employment and the native/migrant wage ratio---deviate from the listed targets.
The artificial economy is therefore stylised rather than tightly identified; counterfactual comparisons across mechanism levels remain internally valid, but levels should not be read as calibrated to any observed economy.
