...
Under \emph{M6}, the wage index \emph{rises} by \MSixShortWage{} percentage points in the short run and \MSixLongWage{} percentage points in the long run (8--12 years), while short-run native employment is \MSixEmpShort{}\% and unemployment \MSixUnempShort{}\%; native employment declines gradually over the post-shock horizon (Figure~\ref{fig:paths}).
...
\begin{table}[htbp]
  ...
  \begin{tabular}{p{0.06\textwidth}p{0.52\textwidth}cp{0.22\textwidth}}
    ...
    \midrule
    H1 & Competition when margins fixed & Partial & \emph{M0}: $\approx$\MZeroShortWage{} pp wages; \MZeroUnempShort{}\% unemp. \\
...
When migrants consume locally, firms enter, capital adjusts, natives specialise, migrants entrepreneur, and innovation responds (\emph{M6}), the same shock produces rising wage-index trajectories alongside a gradual decline in native employment share.
